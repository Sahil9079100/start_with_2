...
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:3121', 'https://startwith.live', 'https://3a9a33cf9829.ngrok-free.app', 'https://coruscating-crumble-6992a8.netlify.app','https://emailservice.startwith.live'],
    credentials: true,
