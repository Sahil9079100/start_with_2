...
app.use(cors({
    origin: ['http://localhost:5173', 'https://backend.startwith.live', 'http://localhost:3121', 'https://startwith.live','https://startwith.co', 'https://60f01cb99d34.ngrok-free.app', 'https://coruscating-crumble-6992a8.netlify.app', 'https://emailservice.startwith.live'],
    credentials: true,
